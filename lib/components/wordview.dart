...
class WordView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container
      (
      decoration: new BoxDecoration(borderRadius: BorderRadius.circular(20),border: new Border.all(color: Colors.blueAccent,width: 2)),child:
         ...
         Column(children: <Widget>[
             Container
               (
                 ...
                 decoration: new BoxDecoration(borderRadius: BorderRadius.circular(10),border: new Border.all(color: Colors.grey,width: 2),
